      ...
      <header className="text-center mb-12 animate-fade-in-up">
        <div className="flex items-center justify-center gap-3 mb-3">
          <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
            <circle cx="20" cy="20" r="18" stroke="#06b6d4" strokeWidth="2" opacity="0.6" />
            <circle cx="12" cy="16" r="3" fill="#06b6d4" />
            <circle cx="28" cy="16" r="3" fill="#f43f5e" />
            <circle cx="20" cy="28" r="3" fill="#06b6d4" />
            <line x1="14" y1="17" x2="26" y2="17" stroke="#334155" strokeWidth="1.5" />
            <line x1="13" y1="18" x2="19" y2="26" stroke="#334155" strokeWidth="1.5" />
            <line x1="27" y1="18" x2="21" y2="26" stroke="#334155" strokeWidth="1.5" />
          </svg>
        ...
        <div className="animate-fade-in-up space-y-8">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-white/5 border border-border-glass text-text-secondary hover:text-text-primary hover:bg-white/10 transition-all text-sm font-medium"
            >
              ← New Analysis
            </button>
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-accent-cyan to-accent-violet text-white font-medium text-sm hover:opacity-90 transition-opacity"
              >
                ↓ Download JSON
              </button>
            </div>
